# helpers.py
#
# defines functions to be used in main.py consists of a csv-reader, 
# a score-function, a function to compute the running time of main.py,
# and function to run different algorithms in the main file.
# 
...
def dijkstra_function(graph, criticals, non_criticals, all_stations, max_trains):
    new_graph = graph
    counter = 0
    critical_counter = 0
    neighbor_counter = 0
    ...
    for i in range(max_trains):
            ...
            while True:           
                ...
                # iterate over every possible destination
...
def bfs_function(graph, criticals, non_criticals, all_stations, max_trains, minute_counter):
    new_graph = graph
    counter = 0
    critical_counter = 0
    neighbor_counter = 0
